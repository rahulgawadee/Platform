      ...
      <div className="bg-white w-full max-w-5xl rounded-lg shadow-lg overflow-hidden">
        <form onSubmit={handleSubmit}>
          ...
          <div className="p-6 overflow-y-auto max-h-[80vh]">
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    {newCourse.thumbnailPreview ? (
                      ...
                      <div className="w-40 h-24 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-md bg-gray-50 text-gray-400">
                        No thumbnail
                      </div>
                    )}
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-2">Recommended size: 1280x720px (JPG, PNG)</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-800">Course Modules</h3>
                <span className="text-sm text-gray-500">
                  {newCourse.modules.length} module{newCourse.modules.length !== 1 ? 's' : ''} added
                </span>
              </div>
              ...
              {newCourse.modules.length > 0 ? (
                <div className="space-y-4 mb-6">
                  {newCourse.modules.map((module, moduleIndex) => (
                    <div key={moduleIndex} className="border border-gray-200 rounded-lg p-4 shadow-sm">
                        ...
                        <div className="mt-3 pl-4 border-l-2 border-gray-200">
                          ...
                          <ul className="space-y-2">
                            {module.lessons.map((lesson, lessonIndex) => (
                              <li key={lessonIndex} className="text-sm text-gray-600 flex items-start">
                      ...
                      {module.quiz && module.quiz.questions.length > 0 && (
                        <div className="mt-3 pl-4 border-l-2 border-gray-200">
                          <h5 className="text-sm font-medium text-gray-700 mb-1">Quiz</h5>
              ...
              <div className="bg-gray-50 rounded-lg border p-4">
                <h4 className="font-medium text-gray-800 mb-4">Add New Module</h4>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t pt-4 mt-4">
                    <h5 className="font-medium text-gray-800 mb-3">Add Lesson</h5>
                  ...
                  {/* Add Quiz Question */}
                  <div className="border-t pt-4 mt-4">
                    <h5 className="font-medium text-gray-800 mb-3">Add Quiz (Optional)</h5>
          ...
          <div className="bg-gray-50 px-6 py-4 border-t flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={!newCourse.title || !newCourse.description || newCourse.modules.length === 0}
